...
The limiting case of $Z_t = \sigma W_t$ a Brownian motion, corresponds to the growth rates $r_t$ following a geometric Brownian motion in discrete time. This case is more tractable and all positive integer moments $\mathbb{E}[(B_i)^n]$ can be computed exactly. This case is discussed in [this](https://arxiv.org/abs/1505.02834) paper, and a statistical mechanics analogy to a lattice gas is given [here](https://link.springer.com/article/10.1007/s10955-013-0889-3). Chapter 2 of [Pirjol (2022)](https://link.springer.com/book/10.1007/978-3-031-11143-3) gives a pedagogical discussion with Mathematica codes.
